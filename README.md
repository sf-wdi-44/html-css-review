...
Answer the [questions](https://docs.google.com/document/d/1B9SHWew4KaXzlqD7YyrQ8Ar7AI3ZbCl9MSnzGsSKn0I/edit?usp=sharing) assigned to your group and record your responses on the board. Feel free to do some research if you're not sure! Some places to check: [resource.md](resource.md), [WDI fundamentals](http://fundamentals.generalassemb.ly/), or the sites in [More Resources](#more-resources).
